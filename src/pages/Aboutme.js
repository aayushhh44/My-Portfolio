  ...
  const FAQItem = ({question, answer}) =>{
    ...
    return(
      ...
      <hr className='w-26 border-t dark:border-gray-100 border-gray-600  opacity-40 '/>
        ...
        {isOpen && <p className="px-4 pb-3 text-xs md:text-lg w-full font-poppins -mt-2 mr-16 ">{answer}</p>}
      </div>
      ...
      <div >
        ...
        <div className="pt-36 top-0 text-center md:ml-[200px] lg:ml-[400px] xl:ml-[600px] left-0 max-w-md">
          ...
          <div className='mt-4 gap-2'>
            <button className='p-2 bg-gray-100 dark:bg-gray-900 font-poppins'>Web Analytics</button>
            <button className='p-2 ml-3 bg-gray-100 dark:bg-gray-900 font-poppins'>Im feeling Lucky</button>
          </div>
        ...
        <div className='px-16 sm:py-8 md:mt-6'>
          <p className='text-blue-700 text-sm md:text-xl cursor-pointer mb-3 font-poppins'>Aayush Poudel</p>
          <p className='-mt-3 text-xs md:text-lg mr-20'> <span className='font-bold font-poppins text-gray-500'>Aayush Poudel</span> is a web developer who loves building awesome stuff online. His tech stack includes React for dynamic user interfaces, Node.js for scalable server-side development, Tailwind CSS for styling, and MongoDB for efficient database management.... </p>


  {/* People also asks */}
          <div>
          <p className='text-blue-600 mt-5 text-xl mb-2 font-poppins mr-9'>People also ask :</p>
