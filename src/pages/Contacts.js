        ...
        <div className="p-16 flex-col justify-center items-center sm:flex-row flex gap-8">
          <div className="bg-[#922232] dark:bg-white flex flex-col justify-center gap-6 h-96 p-4 w-full sm:w-1/3">
            ...
            <div className="flex flex-col gap-8 font-poppins">
              <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/aayush4444/" className="flex gap-4 cursor-pointer text-white dark:text-black">
                <FaFacebook size={30} />
                <p>Facebook</p>
              </a>
              <a target="_blank" rel="noopener noreferrer" href="https://github.com/aayushhh44" className="flex gap-4 cursor-pointer text-white dark:text-black">
                <FaGithub size={30} className="cursor-pointer text-white dark:text-black" />
                <p>Github</p>
              </a>
              <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/aayblush" className="flex gap-4 cursor-pointer text-white dark:text-black">
